...
export default {
    ...
    setupAppTemplateCommand() {
        ...
        typeKeys.forEach(type => {
            ...
            templates.forEach(template => {
                atom.commands.add('atom-workspace', `minxing:initApp,type=${type},template=${template}`,
    ...
    setupFileTemplateCommand() {
        ...
        templates.forEach(template => {
            atom.commands.add('atom-workspace', `minxing:addFileTemplate,template=${template}`,
                (event) => (this.convertCommandToMethod({
                    event: event
                })))
        })
